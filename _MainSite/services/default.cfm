...
<cfsavecontent variable="content">
	<div class="row">
		...
		<div class="well">
			Do you have a <strong>requirement involving data</strong> for which you are not sure about the feasability? Get in touch, we love to chat. <a data-toggle="modal" href="#contact" class="btn btn-primary btn-large">Contact us »</a>
		</div>

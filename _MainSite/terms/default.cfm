<cfsavecontent variable="description">Copyright, licensing, terms of use</cfsavecontent>
<cfsavecontent variable="title">Copyright and terms of use</cfsavecontent>
<cfsavecontent variable="content">
	<div class="row">
		<div class="span6">
			...
			<p>The Website is available on an "as is" basis and is used under the sole and exclusive liability of the visitors. In no event shall Mango Information Systems SPRL be liable, whether in tort, in contract or otherwise, for any direct, indirect, consequential or other damages arising out of, or otherwise resulting from, the access to, or use of, the Website, including, without limitation, any kind of loss caused by service interruptions or viruses or by any similar inconvenience. Mango Information Systems SPRL does neither accept any liability for electronic communications effected via the Website.</p>
			<h2 id="jurisdiction">Applicable law and jurisdiction</h2>
			<p>This Website and all the content thereof, as well as the use of this Website, are solely and exclusively governed by Belgian law, without application of conflict of law rules. Only the Belgian courts, to the exclusion of all others, have jurisdiction in the event of any dispute concerning this Website and the use thereof.</p>
		</div>
		<div class="span4 well">
			<h2 id="privacy-policy">Privacy policy</h2>
			<p>Any personal data processed or collected on the Website is processed under the control of Mango Information Systems SPRL, who is the data controller under the Act of 8 December 1992 on the protection of privacy with respect to the processing of personal data.</p>
			<p>Mango Information Systems SPRL might collect personal data from your voluntary submission, or by accessing publicly available content from third-party websites, in accordance with their terms of use.</p>
			<p>You have the right to access your personal data and to have the same rectified or deleted. In this respect send us either a registered letter by mail (cf. <a target="_blank" href="/company/#hcard-Mango-Information-Systems">our postal address</a>), or a message using the <a href="#contact" data-toggle="modal">contact form</a> in this website.</p>
		</div>
	</div>
</cfsavecontent>
